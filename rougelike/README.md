...
- **Boss**：死神骑士、虫巢母皇、暗影刺客（弹速 +30）、**熔岩巨兽**地狱/不可能 40% 出场，3200血，全弹速 +40，死亡 256 发新星；Boss 掉落道具本局去重
- **地图事件**：治疗祭坛 / 风险祭坛 / 传送门 + 屏外箭头
- **灵魂宝库**：天赋 + 圣物（11 种：`影侍守卫` 受击 45% 眩晕 0.4s（对 Boss 无效）+ 10s 双影袭，不可升级）/ 成就 8 种（含「万法归宗」：一局 6 武器全进化）/ 死神之指（手动世界坐标修复，刺客 60 半径自适应）
