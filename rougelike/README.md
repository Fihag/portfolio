...
- **Boss**：死神骑士、虫巢母皇、暗影刺客（弹速 +30）、**熔岩巨兽**地狱/不可能 40% 出场，3200血，全弹速 +40，死亡 256 发新星；**天罚炮台**（原地弹幕要塞，固定降临地图正中心：常驻 0.22s 速射弹（弹速 405）/ 2s 扇形炮击 9 发 ±10° 连发两次（弹速 425）/ 4s 爆裂弹×3（弹速 425 射程 800）——逼近玩家 210 内或射程尽头爆炸，爆心 35 伤（半径 140）并分裂 30 发环形弹（12° 整圆，弹速 355；尽头引爆 475）/ 0.7s 预警扫射激光（长 1200 穿透，30 伤）/ 每 8s 投放 3 只精英自爆虫（×1.4），2500 血 65% 减伤；**在场光环**：小怪刷怪频率 +10%、速度 +10%、血量/接触伤 +5%；**死亡神罚**：全图 100 颗陨石两波约 7s 坠落（预警 1s、半径 105、每颗 50 伤）；技能伤害随全 Boss 共用出场次数 +6%/次（封顶 4 次）并吃难度倍率）；Boss 掉落道具本局去重
