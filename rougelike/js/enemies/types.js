            // ==================== 敌人类型 ====================
            const ENEMY_TYPES = {
                zombie:   { name: '小僵尸', hp: 35, speed: 60, size: 12, color: '#44cc66', xpValue: 12, damage: 7,  shape: 'circle' },
                runner:   { name: '疾行者', hp: 25, speed: 150, size: 9, color: '#ff5544', xpValue: 18, damage: 9,  shape: 'triangle' },
                brute:    { name: '巨兽',   hp: 90, speed: 40, size: 22, color: '#bb44ee', xpValue: 36, damage: 12, shape: 'square' },
                wraith:   { name: '怨灵',   hp: 33, speed: 55, size: 11, color: 'rgba(200,200,255,0.7)', xpValue: 17, damage: 0, shape: 'circle', isGhost: true, slowAmount: 0.35, slowDuration: 2, dotDamage: 1.5, dotDuration: 2 },
                pyromancer: { name: '炎术士', hp: 31, speed: 48, size: 9, color: '#ff6633', xpValue: 24, damage: 0, shape: 'triangle', isRanged: true, attackRange: 150, fireballDamage: 10, fireballSpeed: 180, fireballCooldown: 2.6 },
                bomber:     { name: '自爆虫', hp: 19, speed: 175, size: 8, color: '#ff6644', xpValue: 10, damage: 0, shape: 'circle' },
                warlock:    { name: '咒术师', hp: 37, speed: 42, size: 10, color: '#aa66dd', xpValue: 26, damage: 0, shape: 'triangle' },
                turret:     { name: '天罚炮台', hp: 2500, speed: 0, size: 30, color: '#6a5a2a', xpValue: 200, damage: 50, shape: 'square', isBoss: true, shieldBase: 1000, scale: { hpRate: 0.30, shieldRate: 0.25, contactRate: 0.06, speedRate: 0, speedCap: 0 } },
                ...
                hatchling:  { name: '巢穴幼体', hp: 30, speed: 135, size: 8, color: '#a8e063', xpValue: 12, damage: 9, shape: 'circle' },
                ...
                moonwitch: { name: '幽月魔女', hp: 2200, speed: 60, size: 26, color: '#3a2a6e', xpValue: 200, damage: 30, shape: 'circle', isBoss: true, auraColor: 'rgba(100,70,220,0.6)', scale: { hpRate: 0, contactRate: 0, speedRate: 0, speedCap: 0 } },
