            // ==================== 敌人类型 ====================
            const ENEMY_TYPES = {
                zombie:   { name: '小僵尸', hp: 32, speed: 60, size: 12, color: '#44cc66', xpValue: 12, damage: 7,  shape: 'circle' },
                runner:   { name: '疾行者', hp: 22, speed: 150, size: 9, color: '#ff5544', xpValue: 18, damage: 9,  shape: 'triangle' },
                brute:    { name: '巨兽',   hp: 87, speed: 40, size: 22, color: '#bb44ee', xpValue: 36, damage: 12, shape: 'square' },
                wraith:   { name: '怨灵',   hp: 30, speed: 55, size: 11, color: 'rgba(200,200,255,0.7)', xpValue: 17, damage: 0, shape: 'circle', isGhost: true, slowAmount: 0.35, slowDuration: 2, dotDamage: 1.5, dotDuration: 2 },
                pyromancer: { name: '炎术士', hp: 28, speed: 48, size: 9, color: '#ff6633', xpValue: 24, damage: 0, shape: 'triangle', isRanged: true, attackRange: 150, fireballDamage: 10, fireballSpeed: 180, fireballCooldown: 2.6 },
                bomber:     { name: '自爆虫', hp: 16, speed: 175, size: 8, color: '#ff6644', xpValue: 10, damage: 0, shape: 'circle' },
                warlock:    { name: '咒术师', hp: 34, speed: 42, size: 10, color: '#aa66dd', xpValue: 26, damage: 0, shape: 'triangle' },
                ...
                hatchling:  { name: '巢穴幼体', hp: 27, speed: 135, size: 8, color: '#a8e063', xpValue: 12, damage: 9, shape: 'circle' },
                ...
                lavaling:  { name: '熔岩幼体', hp: 20, speed: 95, size: 9, color: '#ff6622', xpValue: 10, damage: 6, shape: 'circle', isGhost: true, slowAmount: 0.35, slowDuration: 1.5, dotDamage: 2, dotDuration: 2 }
            };
